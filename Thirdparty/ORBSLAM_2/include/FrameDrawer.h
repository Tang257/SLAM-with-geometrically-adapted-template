...
namespace ORB_SLAM2
{
    ...
    public:
        ...
        cv::Mat getImageTexture(); // changed
    ...
    protected:
        ...
        std::vector<std::pair<int, std::pair<cv::KeyPoint, cv::KeyPoint>>> innovation;
        std::vector<std::pair<int, std::pair<cv::KeyPoint, cv::KeyPoint>>> innovationOutlier;
