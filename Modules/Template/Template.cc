...
namespace defSLAM
{
  ...
  cv::Mat Template::getAdaptiveTexture(){
    // cv::imwrite("/home/tang/GithubRep/SD-DefSLAM/datasets/phantom_datasets/processInfo/kfimage.jpg", kf->KFimage.clone());
    return kf->KFimage.clone();
  }
} // namespace defSLAM
