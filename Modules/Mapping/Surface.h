...
namespace defSLAM
{
  ...
  public:
    ...
    ************/
    ...
    void getAdaptiveVertex(std::vector<cv::Mat> &NodesSurface, std::vector<std::vector<int>> &facets, uint, uint, uint, uint, std::vector<std::vector<cv::Point>> sample_contours);
